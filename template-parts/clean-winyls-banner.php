<section>
    <div class="container px-0 cleaning-winyls-banner">
        <img loading="lazy" src="<?php echo get_theme_file_uri(); ?>/public/images/winyl-mockup-fs-no-shadow.avif"
            alt="Usługa mycia płyt winylowych">
        <div class="cleaing-winyls-content">
