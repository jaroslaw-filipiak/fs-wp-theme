...
<section class="bg-stone-200 overflow-hidden">
    ...
    <div class="flex -mx-4 products-slider relative">
        ...
        <div class="fajnestarocie-swiper-button-prev">
            ...
            <svg class="fill-white rotate-180" width="44" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="fajnestarocie-swiper-button-next">
            ...
            <svg class="fill-white" width="44" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 511.996 511.996" xml:space="preserve">
                <g>
                    <g>
                        <path
...
<section id="categories" class="py-12 lg:py-24 overflow-hidden bg-stone-200">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-6xl mx-auto mb-10 text-center">
            ...
            <p class="font-heading  lg:leading-relaxed text-3xl md:text-4xl mt-12 lg:mt-24 max-w-112 mx-auto">
                Najpopularniejsze kategorie produktów</p>
        </div>
                    ...
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full lg:w-2/3 px-4 mb-12 lg:mb-0">
                            <div class="max-w-3xl">
                                ...
                                <blockquote class="text-3xl text-gray-700 font-heading mt-12 relative ">
                                    <svg class="absolute -top-6 -left-6 w-34 h-34 opacity-10"
                                    ...
                                    pięknych
                                    obiektów z przeszłości, które zasługują na
                                    drugie życie w nowoczesnych domach. Wierzymy, że kaźdy antyk niesie ze sobą duszę i
                                    opowieść, która moźe wzbogacić Twoje wnętrze i stworzyć niepowtarzalny klimat pełen
                                    charakteru i elegancji.
                                </blockquote>
                            </div>
                        </div>
                        <div class="w-full lg:w-1/3 px-4">
                            <div>
                                ...
                                <div class="mb-16">
                                    <span
                                        class="block text-5xl"><?php echo wp_count_posts('olx_review')->publish; ?></span>
                ...
                <div class="reviews-slider swiper">
                    <div class="swiper-wrapper">
                        ...
                        $args = array(
                            ...
                            'meta_query' => array(
                                array(
                                    'key' => 'reviewtags', // Zaktualizowano do ACF
                                    'value' => '',
                                    'compare' => '!='
                                )
                            )
