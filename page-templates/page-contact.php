                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
                        <div class="max-w-lg py-7">
                            <h1 class="font-heading text-4xl sm:text-6xl tracking-sm mb-6"><?php the_field( 'title' ); ?></h1>
                    ...
                    <?php $contact_img = get_field( 'contact_img' ); ?>
                        <?php if($contact_img): ?>
                        <div style="background-image: url('<?php echo esc_url( $contact_img['url'] ); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;" class="w-full lg:w-1/2 px-4 bg-stone-300">
