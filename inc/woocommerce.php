 ...
 * @return void
 */
function fajnestarocie_woocommerce_scripts() {
	wp_enqueue_style( 'fajnestarocie-woocommerce-style', get_template_directory_uri() . '/woocommerce.css', array(), _S_VERSION );
	...
	wp_add_inline_style( 'fajnestarocie-woocommerce-style', $inline_font );
}
add_action( 'wp_enqueue_scripts', 'fajnestarocie_woocommerce_scripts' );
...
if ( ! function_exists( 'fajnestarocie_woocommerce_cart_link' ) ) {
	...
	function fajnestarocie_woocommerce_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'fajnestarocie' ); ?>">
			<?php
